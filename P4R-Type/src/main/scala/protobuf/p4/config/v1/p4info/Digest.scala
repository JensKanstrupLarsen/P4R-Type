...
final case class Digest(
    ...
    def clearPreamble: Digest = copy(preamble = _root_.scala.None)
    def withPreamble(__v: p4.config.v1.p4info.Preamble): Digest = copy(preamble = Option(__v))
    ...
    def clearTypeSpec: Digest = copy(typeSpec = _root_.scala.None)
    def withTypeSpec(__v: p4.config.v1.p4types.P4DataTypeSpec): Digest = copy(typeSpec = Option(__v))
    ...
    def companion: p4.config.v1.p4info.Digest.type = p4.config.v1.p4info.Digest
    // @@protoc_insertion_point(GeneratedMessage[p4.config.v1.Digest])
}

object Digest extends scalapb.GeneratedMessageCompanion[p4.config.v1.p4info.Digest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[p4.config.v1.p4info.Digest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): p4.config.v1.p4info.Digest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[p4.config.v1.p4info.Digest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = P4InfoProto.javaDescriptor.getMessageTypes().get(21)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = P4InfoProto.scalaDescriptor.messages(21)
  ...
  lazy val defaultInstance = p4.config.v1.p4info.Digest(
    preamble = _root_.scala.None,
    typeSpec = _root_.scala.None
  )
  implicit class DigestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, p4.config.v1.p4info.Digest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, p4.config.v1.p4info.Digest](_l) {
  ...
  ): _root_.p4.config.v1.p4info.Digest = _root_.p4.config.v1.p4info.Digest(
    preamble,
    typeSpec
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[p4.config.v1.Digest])
}
