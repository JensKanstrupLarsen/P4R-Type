...
final case class Meter(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Meter] {
    @transient
    ...
    def clearPreamble: Meter = copy(preamble = _root_.scala.None)
    def withPreamble(__v: p4.config.v1.p4info.Preamble): Meter = copy(preamble = Option(__v))
    def getSpec: p4.config.v1.p4info.MeterSpec = spec.getOrElse(p4.config.v1.p4info.MeterSpec.defaultInstance)
    def clearSpec: Meter = copy(spec = _root_.scala.None)
    def withSpec(__v: p4.config.v1.p4info.MeterSpec): Meter = copy(spec = Option(__v))
    def withSize(__v: _root_.scala.Long): Meter = copy(size = __v)
    ...
    def clearIndexTypeName: Meter = copy(indexTypeName = _root_.scala.None)
    def withIndexTypeName(__v: p4.config.v1.p4types.P4NamedType): Meter = copy(indexTypeName = Option(__v))
    ...
    def companion: p4.config.v1.p4info.Meter.type = p4.config.v1.p4info.Meter
    // @@protoc_insertion_point(GeneratedMessage[p4.config.v1.Meter])
}

object Meter extends scalapb.GeneratedMessageCompanion[p4.config.v1.p4info.Meter] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[p4.config.v1.p4info.Meter] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): p4.config.v1.p4info.Meter = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[p4.config.v1.p4info.Meter] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = P4InfoProto.javaDescriptor.getMessageTypes().get(16)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = P4InfoProto.scalaDescriptor.messages(16)
  ...
  lazy val defaultInstance = p4.config.v1.p4info.Meter(
    preamble = _root_.scala.None,
    spec = _root_.scala.None,
    size = 0L,
    indexTypeName = _root_.scala.None
  )
  implicit class MeterLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, p4.config.v1.p4info.Meter]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, p4.config.v1.p4info.Meter](_l) {
  ...
  ): _root_.p4.config.v1.p4info.Meter = _root_.p4.config.v1.p4info.Meter(
    preamble,
    spec,
    size,
    indexTypeName
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[p4.config.v1.Meter])
}
