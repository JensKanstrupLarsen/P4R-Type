...
/** @param annotationLocations
  ...
  */
@SerialVersionUID(0L)
final case class P4StructTypeSpec(
    members: _root_.scala.Seq[p4.config.v1.p4types.P4StructTypeSpec.Member] = _root_.scala.Seq.empty,
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[P4StructTypeSpec] {
    @transient
    ...
    def addMembers(__vs: p4.config.v1.p4types.P4StructTypeSpec.Member *): P4StructTypeSpec = addAllMembers(__vs)
    def addAllMembers(__vs: Iterable[p4.config.v1.p4types.P4StructTypeSpec.Member]): P4StructTypeSpec = copy(members = members ++ __vs)
    def withMembers(__v: _root_.scala.Seq[p4.config.v1.p4types.P4StructTypeSpec.Member]): P4StructTypeSpec = copy(members = __v)
    def clearAnnotations = copy(annotations = _root_.scala.Seq.empty)
    def addAnnotations(__vs: _root_.scala.Predef.String *): P4StructTypeSpec = addAllAnnotations(__vs)
    def addAllAnnotations(__vs: Iterable[_root_.scala.Predef.String]): P4StructTypeSpec = copy(annotations = annotations ++ __vs)
    def withAnnotations(__v: _root_.scala.Seq[_root_.scala.Predef.String]): P4StructTypeSpec = copy(annotations = __v)
    def clearAnnotationLocations = copy(annotationLocations = _root_.scala.Seq.empty)
    def addAnnotationLocations(__vs: p4.config.v1.p4types.SourceLocation *): P4StructTypeSpec = addAllAnnotationLocations(__vs)
    def addAllAnnotationLocations(__vs: Iterable[p4.config.v1.p4types.SourceLocation]): P4StructTypeSpec = copy(annotationLocations = annotationLocations ++ __vs)
    def withAnnotationLocations(__v: _root_.scala.Seq[p4.config.v1.p4types.SourceLocation]): P4StructTypeSpec = copy(annotationLocations = __v)
    def clearStructuredAnnotations = copy(structuredAnnotations = _root_.scala.Seq.empty)
    def addStructuredAnnotations(__vs: p4.config.v1.p4types.StructuredAnnotation *): P4StructTypeSpec = addAllStructuredAnnotations(__vs)
    def addAllStructuredAnnotations(__vs: Iterable[p4.config.v1.p4types.StructuredAnnotation]): P4StructTypeSpec = copy(structuredAnnotations = structuredAnnotations ++ __vs)
    def withStructuredAnnotations(__v: _root_.scala.Seq[p4.config.v1.p4types.StructuredAnnotation]): P4StructTypeSpec = copy(structuredAnnotations = __v)
    ...
    def companion: p4.config.v1.p4types.P4StructTypeSpec.type = p4.config.v1.p4types.P4StructTypeSpec
    // @@protoc_insertion_point(GeneratedMessage[p4.config.v1.P4StructTypeSpec])
}

object P4StructTypeSpec extends scalapb.GeneratedMessageCompanion[p4.config.v1.p4types.P4StructTypeSpec] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[p4.config.v1.p4types.P4StructTypeSpec] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): p4.config.v1.p4types.P4StructTypeSpec = {
    val __members: _root_.scala.collection.immutable.VectorBuilder[p4.config.v1.p4types.P4StructTypeSpec.Member] = new _root_.scala.collection.immutable.VectorBuilder[p4.config.v1.p4types.P4StructTypeSpec.Member]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __members += _root_.scalapb.LiteParser.readMessage[p4.config.v1.p4types.P4StructTypeSpec.Member](_input__)
        case 18 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[p4.config.v1.p4types.P4StructTypeSpec] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      p4.config.v1.p4types.P4StructTypeSpec(
        members = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[p4.config.v1.p4types.P4StructTypeSpec.Member]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = P4TypesProto.javaDescriptor.getMessageTypes().get(10)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = P4TypesProto.scalaDescriptor.messages(10)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = p4.config.v1.p4types.P4StructTypeSpec.Member
  ...
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] =
    Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]](
      _root_.p4.config.v1.p4types.P4StructTypeSpec.Member
    )
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = p4.config.v1.p4types.P4StructTypeSpec(
  ...
  final case class Member(
      ...
      def withTypeSpec(__v: p4.config.v1.p4types.P4DataTypeSpec): Member = copy(typeSpec = Option(__v))
      def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
      def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
      def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
        (__fieldNumber: @_root_.scala.unchecked) match {
      ...
      def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
      def companion: p4.config.v1.p4types.P4StructTypeSpec.Member.type = p4.config.v1.p4types.P4StructTypeSpec.Member
      // @@protoc_insertion_point(GeneratedMessage[p4.config.v1.P4StructTypeSpec.Member])
  }
  
  object Member extends scalapb.GeneratedMessageCompanion[p4.config.v1.p4types.P4StructTypeSpec.Member] {
    implicit def messageCompanion: scalapb.GeneratedMessageCompanion[p4.config.v1.p4types.P4StructTypeSpec.Member] = this
    def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): p4.config.v1.p4types.P4StructTypeSpec.Member = {
      ...
      p4.config.v1.p4types.P4StructTypeSpec.Member(
          name = __name,
          typeSpec = __typeSpec,
          unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
      )
    }
    implicit def messageReads: _root_.scalapb.descriptors.Reads[p4.config.v1.p4types.P4StructTypeSpec.Member] = _root_.scalapb.descriptors.Reads{
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
        p4.config.v1.p4types.P4StructTypeSpec.Member(
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = p4.config.v1.p4types.P4StructTypeSpec.javaDescriptor.getNestedTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = p4.config.v1.p4types.P4StructTypeSpec.scalaDescriptor.nestedMessages(0)
    def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
      var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
      (__number: @_root_.scala.unchecked) match {
    ...
    def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
    lazy val defaultInstance = p4.config.v1.p4types.P4StructTypeSpec.Member(
      name = "",
      typeSpec = _root_.scala.None
    )
    implicit class MemberLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, p4.config.v1.p4types.P4StructTypeSpec.Member]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, p4.config.v1.p4types.P4StructTypeSpec.Member](_l) {
    ...
    ): _root_.p4.config.v1.p4types.P4StructTypeSpec.Member = _root_.p4.config.v1.p4types.P4StructTypeSpec.Member(
      name,
      typeSpec
    )
    // @@protoc_insertion_point(GeneratedMessageCompanion[p4.config.v1.P4StructTypeSpec.Member])
  }
  
  implicit class P4StructTypeSpecLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, p4.config.v1.p4types.P4StructTypeSpec]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, p4.config.v1.p4types.P4StructTypeSpec](_l) {
    def members: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[p4.config.v1.p4types.P4StructTypeSpec.Member]] = field(_.members)((c_, f_) => c_.copy(members = f_))
  ...
  def of(
    members: _root_.scala.Seq[p4.config.v1.p4types.P4StructTypeSpec.Member],
  ...
  ): _root_.p4.config.v1.p4types.P4StructTypeSpec = _root_.p4.config.v1.p4types.P4StructTypeSpec(
    members,
    annotations,
    annotationLocations,
    structuredAnnotations
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[p4.config.v1.P4StructTypeSpec])
}
