...
final case class PacketOut(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[PacketOut] {
    @transient
    ...
    def withPayload(__v: _root_.com.google.protobuf.ByteString): PacketOut = copy(payload = __v)
    def clearMetadata = copy(metadata = _root_.scala.Seq.empty)
    def addMetadata(__vs: p4.v1.p4runtime.PacketMetadata *): PacketOut = addAllMetadata(__vs)
    def addAllMetadata(__vs: Iterable[p4.v1.p4runtime.PacketMetadata]): PacketOut = copy(metadata = metadata ++ __vs)
    def withMetadata(__v: _root_.scala.Seq[p4.v1.p4runtime.PacketMetadata]): PacketOut = copy(metadata = __v)
    ...
    def companion: p4.v1.p4runtime.PacketOut.type = p4.v1.p4runtime.PacketOut
    // @@protoc_insertion_point(GeneratedMessage[p4.v1.PacketOut])
}

object PacketOut extends scalapb.GeneratedMessageCompanion[p4.v1.p4runtime.PacketOut] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[p4.v1.p4runtime.PacketOut] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): p4.v1.p4runtime.PacketOut = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[p4.v1.p4runtime.PacketOut] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = P4RuntimeProto.javaDescriptor.getMessageTypes().get(32)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = P4RuntimeProto.scalaDescriptor.messages(32)
  ...
  lazy val defaultInstance = p4.v1.p4runtime.PacketOut(
    payload = _root_.com.google.protobuf.ByteString.EMPTY,
    metadata = _root_.scala.Seq.empty
  )
  implicit class PacketOutLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, p4.v1.p4runtime.PacketOut]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, p4.v1.p4runtime.PacketOut](_l) {
  ...
  ): _root_.p4.v1.p4runtime.PacketOut = _root_.p4.v1.p4runtime.PacketOut(
    payload,
    metadata
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[p4.v1.PacketOut])
}
